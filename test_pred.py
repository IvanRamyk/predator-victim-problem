...
from evaluate import evaluate, evaluate_length, victim_custom
...
def gen_policy(PVEnv, i, isVictim):
    ...
    if isVictim:
        ...
        # ModelCatalog.register_custom_action_dist("pred_dist", PredatorActionDist)
        ModelCatalog.register_custom_model("predator_model", PredatorModel)

        config2 = {
            "model": {
                    "custom_model": "predator_model",
                    # "custom_action_dist": "pred_dist",
                },
        }
...
try:
    if str == "1":
        ...
        evaluate_length(trainer, PVEnv, "from_policy.txt", 1000)
